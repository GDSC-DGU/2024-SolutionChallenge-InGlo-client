...
class CrazyVotingPage extends StatefulWidget {
  final int sdgs;
  final int problemId;
  const CrazyVotingPage(
      {required this.sdgs, required this.problemId, super.key});
              ...
              onPressed: () async {
                if (checkedNumber.isEmpty) {
                  showDialog(
                    ...
                    builder: ((context) {
                      return AlertDialog(
                        ...
                        content: const Text("Please Choose one Crazy 8's."),
                        actions: <Widget>[
                          ElevatedButton(
                            onPressed: () {
                  ...
                  await Future.forEach(checkedNumber, (item) {
                    CrazyService()
                        .postCrazyChoose(problemId, item, context, token);
                  });
